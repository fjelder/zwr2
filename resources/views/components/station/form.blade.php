<div class="card">
    ...
    <div class="mb-4 sm:w-1/3">
        <x-label value="Linia kolejowa" />
        <select id="line_id" name="line_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500">
            @foreach(App\Models\Line::orderBy('number')->get() as $line)
