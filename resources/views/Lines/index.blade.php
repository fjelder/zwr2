        ...
        <div class="relative overflow-hidden sm:rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Numer linii</th>
                            <th scope="col" class="px-4 py-3">Stacja początkowa</th>
                            <th scope="col" class="px-4 py-3">Stacja Końcowa</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">{{$line->stationA}}</td>
                            <td class="px-4 py-3">{{$line->stationB}}</td>
            ...
            <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                    ...
                    <li>
                        <a href="#" aria-current="page" class="z-10 flex items-center justify-center px-3 py-2 text-sm leading-tight border text-sky-600 bg-sky-50 border-sky-300 hover:bg-sky-100 hover:text-sky-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
                    </li>
                    <li>
